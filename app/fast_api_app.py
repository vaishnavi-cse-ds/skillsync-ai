...
if os.getenv("INTEGRATION_TEST") == "TRUE":
    ...
    class DummyCredentials(credentials.Credentials):
        pass
    google.auth.default = lambda *args, **kwargs: (DummyCredentials(), "mock-project-id")
...
app.title = "skillsync-ai"
app.description = "API for interacting with the Agent skillsync-ai"
