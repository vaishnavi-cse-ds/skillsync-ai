...
def test_adk_run_sse(server_fixture: subprocess.Popen[str]) -> None:
    ...
    data = {
        ...
        "new_message": {"role": "user", "parts": [{"text": '{"resume_text": "Experienced software engineer with AWS expertise.", "github_username": "john_doe"}'}]},
        "streaming": True,
    }
...
def test_a2a_chat_stream(server_fixture: subprocess.Popen[str]) -> None:
    ...
    message = Message(
        ...
        role=Role.user,
        parts=[Part(root=TextPart(text='{"resume_text": "Experienced software engineer with AWS expertise.", "github_username": "john_doe"}'))],
    )
    ...
    response = requests.post(
        ...
        json={
            ...
            "input": {
                ...
                "message": '{"resume_text": "Experienced software engineer with AWS expertise.", "github_username": "john_doe"}'
            },
        },
        stream=True,
        timeout=60,
